...
final class AddressesWithExposedIdsNotFoundException extends \Exception implements InvalidValueException
{
    public function __construct($addressIds = "", $code = 0, Throwable $previous = null)
    {
        $message = "Not found addresses with the following exposed Ids: '{$addressIds}'";
